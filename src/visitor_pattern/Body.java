...
public class Body extends Node {
	...
	public Body(Map<String,String> attributes,String innerText){
		this.attributes=attributes;
		this.innerText=innerText;

	}

	public Body(Map<String,String> attributes,Node children){
		this.attributes=attributes;
		this.children=children;
	}


	public Body(Map<String,String> attributes,List<Node> subNodes){
		this.attributes=attributes;
