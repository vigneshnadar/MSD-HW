...
public class LoggingHTMLFactoryTests {
	...
	@Test
	public void test1(){
	AbstractHTMLNodeFactory factory = new LoggingHTMLFactory();
	...
	public void testHTML(){
		...
		Node div = factory.makeDiv(divAtts, "b");
		Map<String,String> noAttributes = new HashMap<String,String>();
		Node html = factory.makeHTML(noAttributes, div);
	...
	public void testHead(){
		...
		Node div = factory.makeDiv(divAtts, "b");
		Map<String,String> noAttributes = new HashMap<String,String>();
		Node head = factory.makeHead(noAttributes, div);
	...
	public void testTitle(){
		...
		Node div = factory.makeDiv(divAtts, "b");
		Map<String,String> noAttributes = new HashMap<String,String>();
		Node title = factory.makeTitle(noAttributes, div);
		...
		subNode.add(div);
		subNode.add(b);
		Node title2 = factory.makeTitle(divAtts, subNode);
		//System.out.println(title.textualRepresentation());
...
//		
	...
	public void testBody(){
		...
		Map<String,String> noAttributes = new HashMap<String,String>();
		Node body = factory.makeBody(noAttributes, div);
